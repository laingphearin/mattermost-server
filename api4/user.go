...
func (api *API) InitUser() {
	...
	api.BaseRoutes.Users.Handle("/friendrequests", api.ApiSessionRequired(sendFriendRequest)).Methods("POST")
	api.BaseRoutes.Users.Handle("/friendrequests", api.ApiSessionRequired(getMyFriendRequests)).Methods("GET")
	api.BaseRoutes.Users.Handle("/friendrequests", api.ApiSessionRequired(updateFriendRequest)).Methods("PUT")
...
func getMyFriendRequests(c *Context, w http.ResponseWriter, r *http.Request) {
	friendRequests, _ := c.App.GetMyFriendRequests()
